...
@Component({
  ...
  template: `
    <header class="bg-slate-950 border-b border-slate-800 h-16 flex items-center justify-between px-6 z-30 shrink-0">
      <!-- Logo -->
      ...
      <div class="flex items-center gap-6">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="text-left max-sm:hidden">
            <p class="text-xs font-semibold text-slate-200">Admin_User</p>
            <p class="text-[10px] text-slate-400">Rol: Data Architect</p>
          </div>
        </div>
      </div>
    </header>
