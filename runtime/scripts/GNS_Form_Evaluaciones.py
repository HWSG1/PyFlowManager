...
def main() -> int:
    ...
    try:
        ...
        log_params(logger, ["GENESYS_CLIENT_ID", "GENESYS_CLIENT_SECRET", "GENESYS_REGION", "HPR_HOST", "HPR_PORT", "HPR_USER", "HPR_PASSWORD", "HANA_SCHEMA", "HANA_USERS_TABLE", "HANA_FORM_EVALUACIONES_TABLE", "HANA_EVALUACIONES_TABLE", "RUN_MODE", "DATE", "START_DATE", "END_DATE", "START_UTC", "END_UTC", "DAYS_BACK", "DRY_RUN"])
